...
public class PorcheView extends LinearLayout {
    private AnimationDrawable drawb;    //后轮动画
    private AnimationDrawable drawf;    //前轮动画
    private TextView senderName;        //发送者名字
    private ImageView senderAvatar;     //发送者头像
    ...
    private void fillUserInfo(TIMUserProfile userProfile) {
        ...
        if (TextUtils.isEmpty(avatarUrl)) {
            UtilImg.loadRound(R.drawable.default_avatar, senderAvatar);
        } else {
            UtilImg.loadRound(avatarUrl, senderAvatar);
        }
