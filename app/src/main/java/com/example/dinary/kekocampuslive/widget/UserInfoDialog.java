...
import com.example.dinary.kekocampuslive.editprofile.CustomProfile;
...
public class UserInfoDialog extends TransParentDialog {
    ...
    private void bindDataToViews() {
        ...
        if (!TextUtils.isEmpty(avatarUrl)) {
            UtilImg.loadRound(R.drawable.default_avatar, user_avatar);
        } else {
            UtilImg.loadRound(avatarUrl, user_avatar);
        }
